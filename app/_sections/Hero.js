...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className={`${sticky ? "mt-14 md:mt-20" : ""} mx-auto flex max-w-screen-lg flex-col gap-6 px-4 pb-12 pt-6 md:grid md:grid-cols-[1.2fr_0.8fr] md:gap-2 md:px-10 md:py-12 lg:py-24`}
    >
